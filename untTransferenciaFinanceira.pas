unit untTransferenciaFinanceira;
...
type
  TfrmTransferenciaFinanceira = class(TForm)
    GroupBox1: TGroupBox;
...
procedure TfrmTransferenciaFinanceira.FormShow(Sender: TObject);
begin
...
procedure TfrmTransferenciaFinanceira.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  frmTransferenciaFinanceira := nil;
  action:= cafree;
end;

procedure TfrmTransferenciaFinanceira.btnGravarClick(Sender: TObject);
var
  cod : integer;
  valor : real;
begin
...
////////FIM VERIFICA SE SALDO E SUFICIENTE/////
  ...
  QRY_MAX_CODIGO.SQL.Add('SELECT MAX(CODIGO) AS CODIGO FROM TRANSFERENCIA_FINANCEIRA');
  QRY_MAX_CODIGO.Open;
  ...
  qry_transLocal.SQL.Add('INSERT INTO TRANSFERENCIA_FINANCEIRA (CODIGO, TP_CODIGO_DE, TP_CODIGO_PARA, VALOR, DATA,OBS)  '+
...
procedure TfrmTransferenciaFinanceira.DBGrid1DrawColumnCell(
...
procedure TfrmTransferenciaFinanceira.btnPesquisarClick(Sender: TObject);
var
...
begin
  ...
  qryPesquisa.SQL.Add('SELECT TF.data, TF.valor, TF.obs,                                          '+
                      ...
                      ' INNER JOIN transferencia_financeira TF ON TF.tp_codigo_de = TP.tp_codigo  '+
                      ' INNER JOIN TIPO_PAGAMENTO TPP ON TPP.tp_codigo = TF.tp_codigo_para        '+
...
procedure TfrmTransferenciaFinanceira.btnRelatorioClick(Sender: TObject);
var
...
procedure TfrmTransferenciaFinanceira.cbo_deKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    cbo_para.SetFocus;
...
procedure TfrmTransferenciaFinanceira.cbo_paraKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    txt_data.SetFocus;
...
procedure TfrmTransferenciaFinanceira.txt_dataKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    txt_valor.SetFocus;
...
procedure TfrmTransferenciaFinanceira.txt_Data_iKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    txt_data_f.SetFocus;
...
procedure TfrmTransferenciaFinanceira.cbo_deEnter(Sender: TObject);
begin
  cbo_de.Color := $00F5EEDE;
end;

procedure TfrmTransferenciaFinanceira.cbo_deExit(Sender: TObject);
begin
  cbo_de.Color := clwindow;
end;

procedure TfrmTransferenciaFinanceira.cbo_paraEnter(Sender: TObject);
begin
  cbo_para.Color := $00F5EEDE;
end;

procedure TfrmTransferenciaFinanceira.cbo_paraExit(Sender: TObject);
begin
  cbo_para.Color := clwindow;
end;

procedure TfrmTransferenciaFinanceira.txt_dataEnter(Sender: TObject);
begin
  txt_data.Color := $00F5EEDE;
end;

procedure TfrmTransferenciaFinanceira.txt_dataExit(Sender: TObject);
begin
  txt_data.Color := clwindow;
end;

procedure TfrmTransferenciaFinanceira.txt_valorEnter(Sender: TObject);
begin
  txt_valor.Color := $00F5EEDE;
end;

procedure TfrmTransferenciaFinanceira.txt_valorExit(Sender: TObject);
begin
  txt_valor.Color := clwindow;
end;

procedure TfrmTransferenciaFinanceira.txt_valorKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key = #13 then
    txt_obs.SetFocus;
...
procedure TfrmTransferenciaFinanceira.txt_Data_iEnter(Sender: TObject);
begin
  txt_data_i.Color :=$00F5EEDE;
end;

procedure TfrmTransferenciaFinanceira.txt_Data_iExit(Sender: TObject);
begin
  txt_data_f.Color := clwindow;
end;

procedure TfrmTransferenciaFinanceira.txt_data_fEnter(Sender: TObject);
begin
  txt_data_f.Color := $00F5EEDE;
end;

procedure TfrmTransferenciaFinanceira.txt_data_fExit(Sender: TObject);
begin
  txt_data_f.Color := clwindow;
end;

procedure TfrmTransferenciaFinanceira.txt_data_fKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
...
procedure TfrmTransferenciaFinanceira.txt_obsEnter(Sender: TObject);
begin
  txt_obs.Color := $00F5EEDE;
end;

procedure TfrmTransferenciaFinanceira.txt_obsExit(Sender: TObject);
begin
  txt_obs.Color := clwindow;
end;

procedure TfrmTransferenciaFinanceira.txt_obsKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    btnGravar.SetFocus;
...
procedure TfrmTransferenciaFinanceira.cbo_de_pesqKeyDown(Sender: TObject;
...
procedure TfrmTransferenciaFinanceira.cbo_para_pesqKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  IF KEY =VK_back then
