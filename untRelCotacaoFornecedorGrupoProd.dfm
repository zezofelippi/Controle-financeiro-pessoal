object frmRelCotacaoFornecedorGrupoProd: TfrmRelCotacaoFornecedorGrupoProd
  Left = 306
  Top = 124
  Width = 567
  Height = 549
  ...
  object qry_pesquisa: TIBQuery
    ...
    SQL.Strings = (
      ...
      ' ITE.COT_QTD, ITE.COT_UNIDADE,'
        ...
        'SUBSTRING(AT_NOME from 1 for 4) AS NOME_RESUMIDO                ' +
        '                           '
      ...
      '                                  '
        ...
        ' GROUP BY AT_CODIGO, AT_NOME, GRP_DESCRICAO, PRO_DESCRICAO, ITE.' +
        'COT_VALOR,'
      
        ' ITE.COT_QTD, ITE.COT_UNIDADE ORDER BY AT_NOME, GRP_DESCRICAO, P' +
        'RO_DESCRICAO')
    Left = 416
    Top = 8
    ...
    object qry_pesquisaNOME_RESUMIDO: TIBStringField
      FieldName = 'NOME_RESUMIDO'
      Size = 200
    end
  end
end
