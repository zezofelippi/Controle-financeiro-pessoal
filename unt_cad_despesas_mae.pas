...
type
  Tfrm_cad_despesas_mae = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
...
var
  frm_cad_despesas_mae: Tfrm_cad_despesas_mae;
...
procedure Tfrm_cad_despesas_mae.FormShow(Sender: TObject);
begin
...
procedure Tfrm_cad_despesas_mae.Button1Click(Sender: TObject);
var
  cod_despesa : integer;
...
////////FIM VERIFICA SE SALDO E SUFICIENTE/////
  ...
  QRY_MAX_CODIGO.SQL.Add('SELECT MAX(CODIGO) AS CODIGO FROM CAD_DESPESA_MAE');
  QRY_MAX_CODIGO.Open;
...
/////FIM VERIFICA SE COD_MES ESTA PREENCHIDO NO CAD. RECEITA E CAD. DESPESA/////////////
  ...
  qry_despesa.SQL.Add('INSERT INTO CAD_DESPESA_MAE (CODIGO, DESPESA_OUTROS, VALOR, DATA, TIP_CODIGO, TDS_CODIGO, COD_MES, TP_CODIGO, COT_CODIGO, AT_CODIGO, CONTA_ATRASADA)  '+
...
procedure Tfrm_cad_despesas_mae.cbo_despesaKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
...
procedure Tfrm_cad_despesas_mae.txt_outra_despesaKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    txt_valor.SetFocus;
...
procedure Tfrm_cad_despesas_mae.txt_valorKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    txt_data.SetFocus;
...
procedure Tfrm_cad_despesas_mae.txt_dataKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key=#13 then
    button1.SetFocus;
...
procedure Tfrm_cad_despesas_mae.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  frm_cad_despesas_mae := nil;
  action:= cafree;
end;

procedure Tfrm_cad_despesas_mae.cbo_despesaEnter(Sender: TObject);
begin
  cboDespesa.Color := $00F5EEDE;
end;

procedure Tfrm_cad_despesas_mae.cbo_despesaExit(Sender: TObject);
begin
  cboDespesa.Color := clwindow;
end;

procedure Tfrm_cad_despesas_mae.txt_outra_despesaEnter(Sender: TObject);
begin
  txt_outra_despesa.Color := $00F5EEDE;
end;

procedure Tfrm_cad_despesas_mae.txt_outra_despesaExit(Sender: TObject);
begin
  txt_outra_despesa.Color := clwindow;
end;

procedure Tfrm_cad_despesas_mae.txt_ValorEnter(Sender: TObject);
begin
  txt_valor.Color := $00F5EEDE;
end;

procedure Tfrm_cad_despesas_mae.txt_ValorExit(Sender: TObject);
begin
  txt_valor.Color := clwindow;
end;

procedure Tfrm_cad_despesas_mae.txt_dataEnter(Sender: TObject);
begin
  txt_data.Color := $00F5EEDE;
end;

procedure Tfrm_cad_despesas_mae.txt_dataExit(Sender: TObject);
begin
  txt_data.Color := clwindow;
end;

procedure Tfrm_cad_despesas_mae.cboDespesaEnter(Sender: TObject);
begin
  cboDespesa.Color :=$00F5EEDE;
end;

procedure Tfrm_cad_despesas_mae.cboDespesaExit(Sender: TObject);
begin
  cboDespesa.Color := clwindow;
end;

procedure Tfrm_cad_despesas_mae.cboDespesaKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
...
procedure Tfrm_cad_despesas_mae.dsDespesaDataChange(Sender: TObject;
  Field: TField);
begin
  qryDespesaSub.Close;
...
procedure Tfrm_cad_despesas_mae.cboDespesaSubKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    txt_outra_despesa.SetFocus;
...
procedure Tfrm_cad_despesas_mae.cboDespesaSubEnter(Sender: TObject);
begin
  cboDespesaSub.Color := $00F5EEDE;
end;

procedure Tfrm_cad_despesas_mae.cboDespesaSubExit(Sender: TObject);
begin
  cboDespesaSub.Color := clwindow;
end;

procedure Tfrm_cad_despesas_mae.Button2Click(Sender: TObject);
begin
  Application.CreateForm(TfrmPesqCotacaoCompraDesp, frmPesqCotacaoCompraDesp);
  frmPesqCotacaoCompraDesp.pesquisar := 'Cad_Despesa_mae';
  frmPesqCotacaoCompraDesp.ShowModal;
end;

procedure Tfrm_cad_despesas_mae.Button3Click(Sender: TObject);
begin
  qry_pesquisa.Close;
  qry_Pesquisa.SQL.Clear;
