unit untRelUnidosContasPagarContasPagas_mae;
...
type
  TfrmRelUnidosContasPagarContasPagas_mae = class(TForm)
    DBGrid1: TDBGrid;
    GroupBox1: TGroupBox;
    gpb1: TGroupBox;
    lbl1: TLabel;
...
var
  frmRelUnidosContasPagarContasPagas_mae: TfrmRelUnidosContasPagarContasPagas_mae;
...
procedure TfrmRelUnidosContasPagarContasPagas_mae.Button1Click(
  Sender: TObject);
var
...
procedure TfrmRelUnidosContasPagarContasPagas_mae.FormShow(Sender: TObject);
begin
  txt_data_i.SetFocus;
...
procedure TfrmRelUnidosContasPagarContasPagas_mae.DBGrid1DrawColumnCell(
...
procedure TfrmRelUnidosContasPagarContasPagas_mae.DBGrid1TitleClick(
  Column: TColumn);
var
  dta,  data1, data2, despesa, despesa_outros, mensagem, ordenar : string;
...
procedure TfrmRelUnidosContasPagarContasPagas_mae.cboDespesaExit(
  Sender: TObject);
begin
 if cboDespesa.Text <> '' then
 begin
...
procedure TfrmRelUnidosContasPagarContasPagas_mae.cboDespesaKeyDown(
...
procedure TfrmRelUnidosContasPagarContasPagas_mae.cboDespesaSubKeyDown(
  Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  IF KEY =VK_back then
...
procedure TfrmRelUnidosContasPagarContasPagas_mae.ItensCotao1Click(
  Sender: TObject);
begin
  Application.CreateForm(TfrmItensCotacaoCompra, frmItensCotacaoCompra);
  frmItensCotacaoCompra.pesquisar := 'Cad_Despesa_mae Contas_Pagar';
