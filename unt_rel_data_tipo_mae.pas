...
type
  Tfrm_rel_data_tipo_mae = class(TForm)
    GroupBox1: TGroupBox;
    Label3: TLabel;
    Label4: TLabel;
    Button1: TButton;
...
var
  frm_rel_data_tipo_mae: Tfrm_rel_data_tipo_mae;
...
procedure Tfrm_rel_data_tipo_mae.txt_data_iEnter(Sender: TObject);
begin
  txt_data_i.Color := $00F5EEDE;
end;

procedure Tfrm_rel_data_tipo_mae.txt_data_iExit(Sender: TObject);
begin
  txt_data_i.Color := clwindow;
end;

procedure Tfrm_rel_data_tipo_mae.txt_data_iKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
    txt_data_f.SetFocus;
...
procedure Tfrm_rel_data_tipo_mae.txt_data_fEnter(Sender: TObject);
begin
  txt_data_f.Color := $00F5EEDE;
end;

procedure Tfrm_rel_data_tipo_mae.txt_data_fExit(Sender: TObject);
begin
  txt_data_f.Color := clwindow;
end;

procedure Tfrm_rel_data_tipo_mae.txt_data_fKeyPress(Sender: TObject;
  var Key: Char);
begin
  IF key =#13 then
    cboDespesa.SetFocus;
...
procedure Tfrm_rel_data_tipo_mae.txt_despesa_outrosEnter(Sender: TObject);
begin
  txt_despesa_outros.Color := $00F5EEDE;
end;

procedure Tfrm_rel_data_tipo_mae.txt_despesa_outrosExit(Sender: TObject);
begin
  txt_despesa_outros.Color := clwindow;
end;

procedure Tfrm_rel_data_tipo_mae.txt_despesa_outrosKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key=#13 then
    button1.SetFocus;
...
procedure Tfrm_rel_data_tipo_mae.FormShow(Sender: TObject);
begin
  txt_data_i.SetFocus;
...
procedure Tfrm_rel_data_tipo_mae.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  frm_rel_data_tipo_mae := nil;
  action:= cafree;
end;

procedure Tfrm_rel_data_tipo_mae.Button1Click(Sender: TObject);
var
...
begin
  ...
  qry_pesquisa.SQL.Add('SELECT CA.codigo, CA.despesa_outros, CA.valor, CA.data, CA.semana,                                   '+
                       ...
                       'FROM CAD_DESPESA_MAE CA, TIPO_DESPESA T, TIPO_DESPESA_SUB TDS                                            '+
  ...
  qry_soma.Close;
  qry_soma.SQL.Clear;
  qry_soma.SQL.Add('SELECT SUM(CA.VALOR) AS TOTAL FROM CAD_DESPESA_MAE CA, TIPO_DESPESA T, TIPO_DESPESA_SUB TDS  '+
...
procedure Tfrm_rel_data_tipo_mae.DBGrid1DrawColumnCell(Sender: TObject;
...
procedure Tfrm_rel_data_tipo_mae.cboDespesaEnter(Sender: TObject);
begin
  cboDespesa.Color := $00F5EEDE;
end;

procedure Tfrm_rel_data_tipo_mae.cboDespesaExit(Sender: TObject);
begin
...
procedure Tfrm_rel_data_tipo_mae.cboDespesaKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
...
procedure Tfrm_rel_data_tipo_mae.btnRelatorioClick(Sender: TObject);
var
...
begin
  ...
  frmRelCadDespesa.qry_pesquisa.SQL.Add('SELECT EXTRACT(month FROM CA.DATA) AS MES, EXTRACT(YEAR FROM CA.DATA) AS ANO,                                    '+
                                        ...
                                        'FROM CAD_DESPESA_MAE CA, TIPO_DESPESA TD, TIPO_DESPESA_SUB TDS where TD.TIP_CODIGO = CA.TIP_CODIGO AND               '+
...
procedure Tfrm_rel_data_tipo_mae.cboDespesaKeyDown(Sender: TObject;
...
procedure Tfrm_rel_data_tipo_mae.dsDespesaDataChange(Sender: TObject;
  Field: TField);
begin
...
procedure Tfrm_rel_data_tipo_mae.cboDespesaSubEnter(Sender: TObject);
begin
  cbodespesaSub.Color := $00F5EEDE;
end;

procedure Tfrm_rel_data_tipo_mae.cboDespesaSubExit(Sender: TObject);
begin
  cboDespesaSub.Color := clwindow;
end;

procedure Tfrm_rel_data_tipo_mae.cboDespesaSubKeyPress(Sender: TObject;
  var Key: Char);
begin
  if key =#13 then
...
procedure Tfrm_rel_data_tipo_mae.DBGrid1TitleClick(Column: TColumn);
VAR
  campo : string;
  dta, dta_cartao, data1, data2, despesa, despesa_outros, mensagem, ordenar : string;
  segunda, terca, quarta, quinta, sexta, sabado, domingo, despesa_sub, ContasAtraso : string;
...
procedure Tfrm_rel_data_tipo_mae.cboDespesaSubKeyDown(Sender: TObject;
  var Key: Word; Shift: TShiftState);
begin
  IF KEY =VK_back then
...
procedure Tfrm_rel_data_tipo_mae.Despesacomitensdacotaodecompra1Click(
  Sender: TObject);
begin

  Application.CreateForm(TfrmItensCotacaoCompra, frmItensCotacaoCompra);
  frmItensCotacaoCompra.pesquisar := 'Cad_Despesa_mae';
