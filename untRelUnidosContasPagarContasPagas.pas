unit untRelUnidosContasPagarContasPagas;
...
type
  TfrmRelUnidosContasPagarContasPagas = class(TForm)
    DBGrid1: TDBGrid;
    GroupBox1: TGroupBox;
    gpb1: TGroupBox;
    lbl1: TLabel;
...
var
  frmRelUnidosContasPagarContasPagas: TfrmRelUnidosContasPagarContasPagas;
...
procedure TfrmRelUnidosContasPagarContasPagas.Button1Click(
  Sender: TObject);
var
...
procedure TfrmRelUnidosContasPagarContasPagas.FormShow(Sender: TObject);
begin
  txt_data_i.SetFocus;
...
procedure TfrmRelUnidosContasPagarContasPagas.DBGrid1DrawColumnCell(
...
procedure TfrmRelUnidosContasPagarContasPagas.DBGrid1TitleClick(
  Column: TColumn);
var
  dta,  data1, data2, despesa, despesa_outros, mensagem, ordenar : string;
...
procedure TfrmRelUnidosContasPagarContasPagas.cboDespesaExit(
  Sender: TObject);
begin
 if cboDespesa.Text <> '' then
 begin
...
procedure TfrmRelUnidosContasPagarContasPagas.cboDespesaKeyDown(
...
procedure TfrmRelUnidosContasPagarContasPagas.cboDespesaSubKeyDown(
  Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  IF KEY =VK_back then
...
procedure TfrmRelUnidosContasPagarContasPagas.ItensCotao1Click(
  Sender: TObject);
begin
