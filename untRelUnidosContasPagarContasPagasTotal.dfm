object frmRelUnidosContasPagarContasPagasTotal: TfrmRelUnidosContasPagarContasPagasTotal
  Left = 111
  Top = 132
  Width = 1133
  Height = 577
  BorderIcons = [biSystemMenu]
  Caption = 'Relatorio de uni'#227'o contas a pagar com contas pagas Filho/Mae'
  Color = clBtnFace
